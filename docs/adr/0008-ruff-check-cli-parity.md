...
- Extending self-checking to `tests/` was put on hold until this redesign landed, since it would otherwise be scoped against a CLI surface that was about to change — see `docs/adr/0009-lint-tests-directory.md`, which resolved it afterward.
